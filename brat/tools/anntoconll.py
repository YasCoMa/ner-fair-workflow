...
#sys.path.append('/aloy/home/ymartins/match_clinical_trial/brat/tools/')
...
def eliminate_overlaps_modified(textbounds):
    eliminate = {}
...
def get_annotations(fn):
    ...
    if( use_modified_overlapping ):
        textbounds = eliminate_overlaps_modified(textbounds)
    else:
...
use_modified_overlapping = False
...
def main_modified(argv=None):
    use_modified_overlapping = True

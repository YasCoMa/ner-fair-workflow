...
class SemanticDescription:
    ...
    def _describe_experiment(self):
        ...
        wfid = self._describe_workflow()
        g.add( ( self.nerwf[_id], self.nerwf.executedBy, self.nerwf[wfid] ) )
